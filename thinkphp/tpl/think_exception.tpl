...
<head>
  ...
  @media (min-width: 768px) {
    .container {
      width: 750px; } }
      .note.note-info,.note.note-danger{-webkit-box-shadow: 0 8px 8px rgba(0,0,0,0.3); -moz-box-shadow: 0 8px 8px rgba(0,0,0,0.3); -ms-box-shadow: 0 8px 8px rgba(0,0,0,0.3); -o-box-shadow: 0 8px 8px rgba(0,0,0,0.3); box-shadow: 0 8px 8px rgba(0,0,0,0.3);-webkit-border-radius:6px;-moz-border-radius:6px;-ms-border-radius:6px;-o-border-radius:6px;border-radius:6px; border-top: #dfdfdf solid 1px;border-right: #dfdfdf solid 1px;}
    ...
    <div class="exception">
        ...
        <div class="container">
            <div class="note note-danger">
                <h2 class="block" style="color:#210406;"><?php echo htmlentities($message); ?></h2>
            </div>
        </div>
