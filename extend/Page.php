...
// +----------------------------------------------------------------------
use \think\Request; //引用thinkphp5的请求类
...
class Page{
    ...
    public function show() {
        ...
        $request = Request::instance(); //实例化thinkphp5的url请求对象
        $url=$request->baseUrl();       // 获取当前URL地址 不含域名
        $this->url = $url."?".http_build_query($this->parameter); //拼接分页的url
        /* 计算分页信息 */
